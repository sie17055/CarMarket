    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmPassword"
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Das Passwort wiederholen-Feld ist ein Pflichtfeld!" />
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="Reset_Click" Text="Ändern" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
